    ...
    <head>
        ...
        <script type="text/javascript">
	        function user_ChkForm() {
	        	...
	        	if(document.frm.res_name.value.trim() == ""){
	    			alert('가게 이름을 입력해주세요.');
	    			return false;
	    		}
	    		if(document.frm.res_addr.value.trim() == ""){
	    			alert('가게 주소을 입력해주세요.');
	    			return false;
	    		}
	    		if(document.frm.res_phone.value.trim() == ""){
	    			alert('가게 전화번호를 입력하셔야 합니다.');
	    			return false;
	    		}
	    		if(document.rm.res_otime.value.trim() == ""){
	    			alert('오픈 시간을 입력해주세요');
	    			return false;
	    		}
	    		if(document.frm.res_ctime.value.trim() == ""){
	    			alert('클로즈 시간을 입력해 주세요.');
	    			return false;
	    		}
	    		if(document.frm.res_content.value.trim() == ""){
	    			alert('내용을 입력해 주세요.');
	    			return false;
	    		}
    ...
    <div class="gongbak"></div>
        ...
        <section id="main">
            <section id="content">
                ...
                <!-- 기본 폼 시작 -->
                <form name="frm" id="frm" action="manage_rest_modifyOk.admin" method="post"  enctype="multipart/form-data" onSubmit='return user_ChkForm(this)' >
                            ...
                            <div class="row">
                                <div class="col-sm-6">                       
                                    <div class="input-group">
                                        ...
                                        <div class="fg-line">
                                                <input type="text" id="res_name" name="res_name" class="form-control" value="<%=res_name %>" placeholder="가게 이름 입력">
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="fg-line">    
                                            <input type="text" id="res_addr" name="res_addr" class="form-control" value="<%=res_addr %>" placeholder="가게 주소 입력">
                                        </div>
                                    </div>
                                    ...
                                    <br/>
  									<div class="input-group">
                                        ...
                                        <div class="fg-line">
                                            <input type="text" id="res_phone" name="res_phone" class="form-control" value="<%=res_phone %>" placeholder="가게 전화 번호 입력">
                                        </div>
                                    </div>
                                    <br />
                                    ...
                                    <div class="input-group form-group">
                                        <span class="input-group-addon"><i class="md md-access-time"></i></span>
                                            ...
                                            <input type='text' id="res_otime" name="res_otime" class="form-control time-picker" data-toggle="dropdown" value="<%=otime %>"  placeholder="오픈 시간">
                                        </div>
                                        <span class="input-group-addon"><i class="md md-access-time"></i></span>
                                            <div class="dtp-container dropdown fg-line">
                                            <input type='text' id="res_ctime" name="res_ctime" class="form-control time-picker" data-toggle="dropdown" value="<%=ctime %>" placeholder="클로즈 시간">
                                        </div>
                                    </div> 
                                </div>
                                <div class="col-sm-6">
							...
							<div class="card-header">
								...
								<div class="card-body card-padding">
                              		<div class="form-group">
                               			<div class="fg-line">
                                    		<textarea name="res_content" id="res_content" class="form-control auto-size"><%=res_content %></textarea>
                                		</div>
                            		</div>
                              		<div class="form-group">
                               			<div class="fg-line">
