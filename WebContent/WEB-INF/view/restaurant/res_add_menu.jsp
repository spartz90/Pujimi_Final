...
<%@page import="kr.co.pujimi.dao.AddMenuDAO"%>
...
<%
	...
	String member_admin = request.getParameter("user_admin");
 	...
 	ArrayList<AddMenuDTO> lists = (ArrayList)request.getAttribute("addMenu_lists");
	
	StringBuffer result = new StringBuffer();
	for(AddMenuDTO aDto : lists){
		
		String like_menu = aDto.getMenu_name();
		String add_date = aDto.getAdd_date();
		
		result.append("<tr>");
		result.append("<td>" + add_date + "</td>");
            ...
            <section id="content">
                <div class="container">
                    <div class="block-header">
                        <h2>메뉴 등록 페이지 <small>오늘의 메뉴를 등록할 수 있는 페이지 입니다.</small></h2>
                            ...
                            <div class="card" style="position: absolute; width : 100%; padding: 10px;">
								...
								<div algin="center">
									...
									<div class="col-sm-6 m-b-20">
										<p class="f-500 m-b-20 c-black">오늘의 메뉴 등록</p>
								...
								<div class="col-sm-6 m-b-20">
										<p class="f-500 m-b-20 c-black">이전에 등록한 메뉴들</p>
    		    	...
    		    	$.ajax({
    		    		...
    		    		success : function(json){
    		    			...
    		    			$.each(json, function (index, value) {
    		    				$('#likeMenuList > tbody').append("<tr><td>" + value.add_date +"</td><td>" + value.menu_name + "</td></tr>" );
    		    				$('#likeList').empty();
							})
