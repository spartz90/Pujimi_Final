...
$(document).ready(function(){
	...
	$('body').on('click', '.line-wrap', function(){
		$(this).toggleClass("mobile-menu-toggle");
		$(".mobile_lojocoo").removeClass("mobile-lojocoo-toggle");
		
		$(".mobile-menu-drop").toggleClass("mobile-menu-drop-toggle");
		$(".mobile-lojocoo-drop").removeClass("mobile-lojocoo-drop-toggle");
    });
    
    $('body').on('click', '.mobile_lojocoo', function(){
		$(this).toggleClass("mobile-lojocoo-toggle");
		$(".line-wrap").removeClass("mobile-menu-toggle");
		
		$(".mobile-lojocoo-drop").toggleClass("mobile-lojocoo-drop-toggle")
		$(".mobile-menu-drop").removeClass("mobile-menu-drop-toggle");
    });
    
    $('body').on('click', '.m-m-d-m', function(){
    ...
    */
    ...
    if ($('.login-content')[0]) {
        ...
        $('body').on('click', '.login-navigation > li:eq(1)', function(){
        ...
        $('body').on('click', '.forget-navigation > li:eq(0)', function(){
            var z = $(this).data('block');
            var t = $(this).closest('.lc-block');
        ...
        // 회원가입
        $('body').on('click', '.register-navigation > li', function(){
            var z = $(this).data('block');
            var t = $(this).closest('.lc-block');
        ...
        $('body').on('click', '#mgr_basic_ok', function(){
            $(".mgr_basic").css("display", "none");
            $(".mgr_detail").css("display", "inline");
        })
        
        $('body').on('click', '.goback', function(){
            $(".mgr_basic").css("display", "inline");
            $(".mgr_detail").css("display", "none");
        })
    }
